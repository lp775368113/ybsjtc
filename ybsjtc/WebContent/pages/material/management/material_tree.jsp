...
<body>
		...
		<div class="mini-splitter" style="width: 100%; height: 100%;">
			<div size="30%" showCollapseButton="true" style="padding: 5px;">
				<ul id="tree1" class="mini-tree"
					url="${pageContext.request.contextPath}/encoding/listTree.do"
					style="width: 100%; height: 100%; padding: 5px;"
					showTreeIcon="false" textField="text"
					onbeforeload="onBeforeTreeLoad" idField="id" parentField="pid"
					resultAsTree="false">
	...
	<script type="text/javascript">
		...
		function onBeforeTreeLoad(e) {
			...
			//可以传递自定义的属性
			params.type = e.node.type; //后台：request对象获取"myField"
