...
<body>
		...
		<form id="form2" name="form2" style="padding-top: 10px" action="#"
			...
			<table cellpadding="0" class="main-table" cellspacing="10px"
				...
				<tr>
					...
					<td width="16%"><input id="maxclass" name="maxclass" readonly="true"
						class="mini-combobox"
				...
				<tr>
					<td class="mini_title" width="16%"><span style="color: red">*</span>物料名称(描述)：
						<input class="mini-hidden" name="invPartDescriptionC" id="invPartDescriptionC" /></td>
	...
	<script type="text/javascript">
		...
		function save() {
			...
			$.ajax({
						url : "${pageContext.request.contextPath}/encoding/saveReplaceData0017.do",
						type : "post",
						dataType : "json",
						cache : false,
						data : data,
