    ...
    <div id="form1">
        ...
        <script type="text/javascript">
            ...
            function save() {
                ...
                var url = "";
                if (mode == "add") {
                    url = "${pageContext.request.contextPath}/BrandSupplier/addSupplier.do"
                } else if (mode == "edit") {
                    url = "${pageContext.request.contextPath}/BrandSupplier/editBrand.do"
                } else {
                    mini.alert("操作失败");
                    return;
                }
