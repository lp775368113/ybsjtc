						...
						<li class="light-blue">
							<a data-toggle="dropdown" href="#" class="dropdown-toggle">
								...
								<span class="user_head">
									...
									<div><%=loginUser.getLoginname().substring(0,1)%></div>
								</span>
								...
								<div class="user_content">
									...
									<div class="head_content">
										<div class="user_head_z">
											...
											<div class=""><%=loginUser.getLoginname().substring(0,1)%></div>
										</div>
										<div class="user_head_text">
											<div>欢迎，<span><%=loginUser.getLoginname()%></span>
											</div>
										</div>
									</div>
									<div class="apply">
									...
									<div class="exit">
										...
										'height=300,width=400,top=150,left=400,scrollbars=yes,status =yes,depended=yes')">
				...
				<ul class="nav nav-list">
					...
					<li class="">
						...
						<c:forEach items="${topChildMenuList}" var="topChildMenu">
							<c:if test="${ topChildMenu.key == topMenu.menuId}">
								<c:forEach items="${topChildMenu.value}" var="topChildMenuValue">
									<li class="" onclick='showTab("${topChildMenuValue.menuId}","${pageContext.request.contextPath}/${topChildMenuValue.menuUrl}","${topChildMenuValue.menuName}");'>
										<a href="javascript:void(0);">
											<i class="menu-icon fa fa-caret-right"></i> ${topChildMenuValue.menuName}
										</a>
										<b class="arrow"></b>
									</li>
								</c:forEach>
				...
				<div class="tabs tabs-style-tzoid">
					<nav>
						...
						<div class="tool">
							...
							<div class="collection_top icon-favorite" title="收藏"></div>
							<div class="warning2 icon-warning" title="报告问题"></div>
							<div class="history2 icon-history" title="查看历史"></div>
							<div class="help icon-help" title="帮助说明"></div>
